...
const questions = [
  ...
  ["How do I create a new playground?", "Open the hamburger menu in the top-left and choose New Playground. Confirm the reset to start with a blank plan. Save the current playground with a name first if you want to keep it in your saved list."],
  ["What is the Outliner?", "The Outliner is the object list in the plan menu. Click a name to select it, rename objects from Select mode, hide or show an object with the eye button, or delete it directly from the list."],
  ["How does snapping work?", "Enable Snap in the Outliner header and choose a grid step such as 0.1, 0.25, 0.5, or 1. Movement buttons and numeric position edits use that increment, which makes aligned plan-mode construction easier."],
  ["Can I enter exact transforms?", "Yes. Select an object and use the Position, Rotation, and Scale numeric fields. Rotation fields use degrees, while position and scale use scene units. This is useful for precise walls, floors, and repeated structures."],
  ["How do I undo or redo a plan edit?", "Use Undo and Redo in the top-left plan menu. Keyboard shortcuts Ctrl/Cmd+Z, Ctrl/Cmd+Shift+Z, and Ctrl/Cmd+Y are also supported. The recent history covers spawning, deleting, duplicating, clearing, and transform edits."],
