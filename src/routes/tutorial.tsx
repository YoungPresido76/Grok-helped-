...
import { ArrowLeft, Box, CircleHelp, Hammer, Link2, Save, Unlink2 } from "lucide-react";
...
const steps = [
  {
    icon: Hammer,
    title: "Choose a tool",
    body: "Use the dashboard at the bottom of the playground. Spawn adds pieces, Weld joins nearby pieces, Demolish breaks a connection, and Scale changes a selected piece.",
  },
  {
    icon: Box,
    ...
    <main className="min-h-dvh bg-bg px-4 py-6 text-fg sm:px-8 sm:py-10">
      <div className="mx-auto max-w-4xl">
        ...
        <section className="mt-6 rounded-toolbar border border-accent/30 bg-accent/10 p-6">
          ...
          <p className="mt-2 text-sm leading-6 text-muted">Load the playground, choose Spawn → Floor, add a Wall, switch to Scale to adjust pieces, then Weld the sections together. Save before experimenting with Demolish.</p>
        </section>
      </div>
    </main>
  );
